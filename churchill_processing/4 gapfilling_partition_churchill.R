...
#+++ with all variables needed for processing later
  EddyProc.C <- sEddyProc$new('churchill', EddyDataWithPosix.F, c('NEE','CH4','H','LE','Ustar','Rg','Tair','Tsoil','RH','VPD'))
  EddyProc.C$sSetLocationInfo(LatDeg =  58.665765, LongDeg = -93.830374, TimeZoneHour = -6)
