...
ggplot(data = df)+
  ...
  geom_point(aes(TIMESTAMP,TC_10cm.c),col='black')+
  scale_y_continuous(limits = c(-25,18))+
  scale_x_datetime(limits = as.POSIXct(c('2023-10-20','2023-10-23'),format="%F"))
```
...
```{r, warning=FALSE}
write.csv(x = df,file = 'C:/Users/klynoe/Documents/iqaluit-tundra-2/R_outputs/met/cleaned_met/IQ2biomet_cleaned.csv',row.names = F,quote = F)
```

Save individual month
```{r , warning=FALSE}
# Define the base file path
base_path = "C:/Users/klynoe/Documents/iqaluit-tundra-2/R_outputs/met/cleaned_met/"
...
```{r, warning=FALSE}
met = fread('C:/Users/klynoe/Documents/iqaluit-tundra-2/R_outputs/met/cleaned_met/IQ2biomet_cleaned.csv')

df = fread('C:/Users/klynoe/Documents/iqaluit-tundra-2/R_outputs/flux/IQ2_fluxes_merged_24.csv')
...
```{r, warning=FALSE}
write.csv(x = df,file = 'C:/Users/klynoe/Documents/iqaluit-tundra-2/R_outputs/flux/IQ2_24_Clean.csv',
          row.names = F,quote = F)
```
