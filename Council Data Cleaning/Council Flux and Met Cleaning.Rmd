...
#for 2022
plot(df$TIMESTAMP,df$FC,ylim = c(-25,25));abline(h=10, col= 'red');abline(h=-14, col='red')
...
# 
# 
# plot(df$TIMESTAMP,co2_flux.limits,ylim = c(-25,25));abline(h=7, col= 'red');abline(h=-10, col='red')
# 
...
# ch4_flux.limits = ifelse(df$ch4_flux < 3 & df$TIMESTAMP <= '2023-9-21 11:00' & df$TIMESTAMP >='2023-9-14 16:30',NA,
...
ggplot(data = df)+theme_bw()+geom_hline(yintercept = 0)+
  geom_point(aes(ts,FC), col='red')+
  geom_point(aes(ts,FC.c), col='black')+
