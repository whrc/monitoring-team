...
## Limits
```{r, warning=FALSE}
hist(df$TA.c,breaks=100)
plot(df$TIMESTAMP,df$TA,ylim = c(-50,50));abline(h=-50, col= 'red');abline(h=50, col='red')
TA = replace(df$TA, df$TA < -50 | df$TA > 50,NA)
hist(TA,breaks=100)
plot(TA)
```
...
TS_2_38_3_1_1.limits = df$TIMESTAMP_2_38_3_1_1

TS_2_38_3_1_1.limits = ifelse(df$TIMESTAMP_2_38_3_1_1 < -5 & df$TIMESTAMP >= '2022-11-16' & df$TIMESTAMP <= '2022-11-29' ,NA, TS_2_38_3_1_1.limits)
...
TS_2_38_3_1_1.limits = ifelse(df$TIMESTAMP_2_38_3_1_1 <= -100 & df$TIMESTAMP >= '2023-2-1' & df$TIMESTAMP <= '2023-6-12' ,NA, TS_2_38_3_1_1.limits)
...
df$TIMESTAMP_2_38_3_1_1.c = ifelse(abs(TS_2_38_3_1_1.limits - mad_filt) > (N * roll.mad),NA,TS_2_38_3_1_1.limits)

#Compare cleaned vs. uncleaned

ggplot(df)+geom_hline(yintercept = 0)+
  geom_point(aes(TIMESTAMP,TS_2_38_3_1_1.limits,col='Uncleaned'))+
  geom_point(aes(TIMESTAMP,df$TIMESTAMP_2_38_3_1_1.c,col='Cleaned'))+
  scale_y_continuous(limits = c(-15,30))+
  scale_x_datetime(limits = as.POSIXct(biomet_dates,format="%F"))+
  scale_color_manual(values=c('black','red'))
...
TS_2_38_3_2_1.limits = df$TIMESTAMP_2_38_3_2_1

TS_2_38_3_2_1.limits = ifelse(df$TIMESTAMP_2_38_3_2_1 <= -25 & df$TIMESTAMP >= '2022-8-1' & df$TIMESTAMP <= '2023-1-30' ,NA, TS_2_38_3_2_1.limits)

df$TIMESTAMP_2_38_3_2_1.c = TS_2_38_3_2_1.limits

ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  geom_line(aes(TIMESTAMP, TS_2_38_3_2_1.c, col = '10 cm'))+
  scale_x_datetime(limits = as.POSIXct(c("2022-8-2",'2023-11-1')))

plot(df$TIMESTAMP_2_38_3_2_1.c)
```
## Rolling MAD
NA here
...
TS_2_38_3_5_1.limits = df$TIMESTAMP_2_38_3_5_1
...
df$TIMESTAMP_2_38_3_5_1.c = ifelse(abs(TS_2_38_3_5_1.limits - mad_filt) > (N * roll.mad),NA,TS_2_38_3_5_1.limits)
...
TS_2_38_3_6_1.limits = df$TIMESTAMP_2_38_3_6_1
...
df$TIMESTAMP_2_38_3_6_1.c = ifelse(abs(TS_2_38_3_6_1.limits - mad_filt) > (N * roll.mad),NA,TS_2_38_3_6_1.limits)
...
TS_2_38_3_7_1.limits = df$TIMESTAMP_2_38_3_7_1
...
df$TIMESTAMP_2_38_3_7_1.c = ifelse(abs(TS_2_38_3_7_1.limits - mad_filt) > (N * roll.mad),NA,TS_2_38_3_7_1.limits)
...
TS_2_38_3_8_1.limits = df$TIMESTAMP_2_38_3_8_1
...
df$TIMESTAMP_2_38_3_8_1.c = ifelse(abs(TS_2_38_3_8_1.limits - mad_filt) > (N * roll.mad),NA,TS_2_38_3_8_1.limits)
...
TS_2_38_3_9_1.limits = df$TIMESTAMP_2_38_3_9_1
...
df$TIMESTAMP_2_38_3_9_1.c = ifelse(abs(TS_2_38_3_9_1.limits - mad_filt) > (N * roll.mad),NA,TS_2_38_3_9_1.limits)
...
TS_2_38_3_10_1.limits = df$TIMESTAMP_2_38_3_10_1
...
df$TIMESTAMP_2_38_3_10_1.c = ifelse(abs(TS_2_38_3_10_1.limits - mad_filt) > (N * roll.mad),NA,TS_2_38_3_10_1.limits)
...
TS_2_38_3_11_1.limits = df$TIMESTAMP_2_38_3_11_1
...
df$TIMESTAMP_2_38_3_11_1.c = ifelse(abs(TS_2_38_3_11_1.limits - mad_filt) > (N * roll.mad),NA,TS_2_38_3_11_1.limits)
...
TS_2_38_3_12_1.limits = df$TIMESTAMP_2_38_3_12_1

TS_2_38_3_12_1.limits = ifelse(df$TIMESTAMP_2_38_3_12_1 <= -40 & df$TIMESTAMP >= '2022-10-15' & df$TIMESTAMP <= '2022-12-15' ,NA, TS_2_38_3_12_1.limits)
...
df$TIMESTAMP_2_38_3_12_1.c = ifelse(abs(TS_2_38_3_12_1.limits - mad_filt) > (N * roll.mad),NA,TS_2_38_3_12_1.limits)
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(biomet_dates))
TS_2_38_4_1_1 = df$TIMESTAMP_2_38_4_1_1
```
## Rolling MAD 
```{r, warning=FALSE}
...
df$TIMESTAMP_2_38_4_1_1.c = ifelse(abs(TS_2_38_4_1_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_4_1_1)
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(biomet_dates))
TS_2_38_4_2_1 = df$TIMESTAMP_2_38_4_2_1
```
## Rolling MAD 
```{r, warning=FALSE}
...
df$TIMESTAMP_2_38_4_2_1.c = ifelse(abs(TS_2_38_4_2_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_4_2_1)
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(biomet_dates))
TS_2_38_4_3_1 = df$TIMESTAMP_2_38_4_3_1
```
...
df$TIMESTAMP_2_38_4_3_1.c = ifelse(abs(TS_2_38_4_3_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_4_3_1)
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(biomet_dates))
TS_2_38_4_4_1 = df$TIMESTAMP_2_38_4_4_1
```
...
df$TIMESTAMP_2_38_4_4_1.c = ifelse(abs(TS_2_38_4_4_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_4_4_1)
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_y_continuous(limits = c(-12,10),
                     expression('Hummock Therms Soil T ('*C*')'))+
  scale_x_datetime(limits = as.POSIXct(biomet_dates))
TS_2_38_4_5_1 = df$TIMESTAMP_2_38_4_5_1
...
df$TIMESTAMP_2_38_4_5_1.c = ifelse(abs(TS_2_38_4_5_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_4_5_1)
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_y_continuous(limits = c(-15,15),
                     expression('Hummock Therms Soil T ('*C*')'))+
  scale_x_datetime(limits = as.POSIXct(biomet_dates))
TS_2_38_4_6_1 = df$TIMESTAMP_2_38_4_6_1
```
## Rolling MAD 
```{r, warning=FALSE}
...
df$TIMESTAMP_2_38_4_6_1.c = ifelse(abs(TS_2_38_4_6_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_4_6_1)
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_y_continuous(limits = c(-10,7.5),
                     expression('Hummock Therms Soil T ('*C*')'))+
  scale_x_datetime(limits = as.POSIXct(biomet_dates))
TS_2_38_4_7_1 = df$TIMESTAMP_2_38_4_7_1
```
## Rolling MAD 
```{r, warning=FALSE}
...
df$TIMESTAMP_2_38_4_7_1.c = ifelse(abs(TS_2_38_4_7_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_4_7_1)
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(biomet_dates))
TS_2_38_4_8_1 = df$TIMESTAMP_2_38_4_8_1
```
...
df$TIMESTAMP_2_38_4_8_1.c = ifelse(abs(TS_2_38_4_8_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_4_8_1)
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_y_continuous(limits = c(-10,5),
                     expression('Hummock Therms Soil T ('*C*')'))+
  scale_x_datetime(limits = as.POSIXct(biomet_dates))
TS_2_38_4_9_1 = df$TIMESTAMP_2_38_4_9_1
```
...
df$TIMESTAMP_2_38_4_9_1.c = ifelse(abs(TS_2_38_4_9_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_4_9_1)
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_y_continuous(limits = c(-10,5),
                     expression('Hummock Therms Soil T ('*C*')'))+
  scale_x_datetime(limits = as.POSIXct(biomet_dates))
TS_2_38_4_10_1 = df$TIMESTAMP_2_38_4_10_1
```
...
df$TIMESTAMP_2_38_4_10_1.c = ifelse(abs(TS_2_38_4_10_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_4_10_1)
...
TS_2_38_4_11_1.limits = df$TIMESTAMP_2_38_4_11_1
```
## Limits
```{r, warning=FALSE}
...
TS_2_38_4_11_1.limits = ifelse(df$TIMESTAMP_2_38_4_11_1 <= -1 & df$TIMESTAMP >= '2022-10-15' & df$TIMESTAMP <= '2022-11-15' ,NA, TS_2_38_4_11_1.limits)
...
TS_2_38_4_11_1.limits = ifelse(df$TIMESTAMP_2_38_4_11_1 <= -2 & df$TIMESTAMP >= '2022-11-20' & df$TIMESTAMP <= '2023-1-20' ,NA, TS_2_38_4_11_1.limits)


TS_2_38_4_11_1.limits = ifelse(df$TIMESTAMP_2_38_4_11_1 <= -1 & df$TIMESTAMP >= '2022-11-20' & df$TIMESTAMP <= '2022-12-20' ,NA, TS_2_38_4_11_1.limits)
...
TS_2_38_4_11_1.limits = ifelse(df$TIMESTAMP_2_38_4_11_1 <= -1 & df$TIMESTAMP >= '2023-1-20' & df$TIMESTAMP <= '2023-2-1' ,NA, TS_2_38_4_11_1.limits)
...
TS_2_38_4_11_1.limits = ifelse(df$TIMESTAMP_2_38_4_11_1 <= -4 & df$TIMESTAMP >= '2023-2-1' & df$TIMESTAMP <= '2023-2-14' ,NA, TS_2_38_4_11_1.limits)
...
TS_2_38_4_11_1.limits = ifelse(df$TIMESTAMP_2_38_4_11_1 <= -4.25 & df$TIMESTAMP >= '2023-2-14' & df$TIMESTAMP <= '2023-2-20' ,NA, TS_2_38_4_11_1.limits)
...
TS_2_38_4_11_1.limits = ifelse(df$TIMESTAMP_2_38_4_11_1 <= -5 & df$TIMESTAMP >= '2023-2-20' & df$TIMESTAMP <= '2023-2-23' ,NA, TS_2_38_4_11_1.limits)
...
TS_2_38_4_11_1.limits = ifelse(df$TIMESTAMP_2_38_4_11_1 <= -2.5 & df$TIMESTAMP >= '2023-5-14' & df$TIMESTAMP <= '2023-6-23' ,NA, TS_2_38_4_11_1.limits)
```
...
df$TIMESTAMP_2_38_4_11_1.c = ifelse(abs(TS_2_38_4_11_1.limits - mad_filt) > (N * roll.mad),NA,TS_2_38_4_11_1.limits)
...
TS_2_38_4_12_1.limits = df$TIMESTAMP_2_38_4_12_1
...
TS_2_38_4_12_1.limits = ifelse(df$TIMESTAMP_2_38_4_12_1 >= -.80 & df$TIMESTAMP >= '2023-06-15' & df$TIMESTAMP <= '2023-07-01' ,NA, TS_2_38_4_12_1.limits)
...
TS_2_38_4_12_1.limits = ifelse(df$TIMESTAMP_2_38_4_12_1 <= -.90 & df$TIMESTAMP >= '2023-07-18' & df$TIMESTAMP <= '2023-08-10' ,NA, TS_2_38_4_12_1.limits)
...
TS_2_38_4_12_1.limits = ifelse(df$TIMESTAMP_2_38_4_12_1 < -1.1 & df$TIMESTAMP >= '2023-07-2' & df$TIMESTAMP <= '2023-07-18' ,NA, TS_2_38_4_12_1.limits)
...
df$TIMESTAMP_2_38_4_12_1.c = ifelse(abs(TS_2_38_4_12_1.limits - mad_filt) > (N * roll.mad),NA,TS_2_38_4_12_1.limits)
...
```{r, warning=FALSE}
plot(df$TIMESTAMP,df$SWIN_6_10_1_1_1.c)
plot(df$TIMESTAMP,df$SWOUT_6_11_1_1_1.c)
plot(df$TIMESTAMP,df$LWIN_6_14_1_1_1.c,ylim = c(0,800))
plot(df$TIMESTAMP,df$LWOUT_6_15_1_1_1.c,ylim = c(0,800))
```
...
#plot(df$TIMESTAMP,mismatch.limits,)
```
...
#FC.energy   = replace(df$FC  ,abs(df$mismatch)>10,NA)
#FCH4.energy = replace(df$FCH4,abs(df$mismatch)>10,NA)
```
...
```{r, warning=FALSE}
Tau.qc      = ifelse(df$Tau,df$qc_Tau == 2,NA)
FC.qc       = ifelse(df$FC_qc == 2,'EP.QC','clean')
FCH4.qc     = ifelse(df$FCH4,df$qc_FCH4 == 2,NA)
LE.qc       = ifelse(df$LE,df$qc_LE == 2,NA)
H.qc        = ifelse(df$H,df$qc_H == 2,NA)
```
...
Tau.limits = df$TAU
df$Tau.limits = ifelse(df$TAU < -1 | df$TAU > .2,1,0)

ggplot(data = df)+
  geom_point(aes(TIMESTAMP,TAU,color = Tau.limits))
```
...
#for 2022
plot(df$TIMESTAMP,df$FC,ylim = c(-40,40));abline(h=25, col= 'red');abline(h=-25, col='red')

# for 2023 and on
plot(df$TIMESTAMP,df$FC,ylim = c(-25,25));abline(h=7, col= 'red');abline(h=-10, col='red')
```

Clean based on graphs, create new variable (FC.limits), and see cleaned product

```{r, warning=FALSE}
FC.limits = df$FC

FC.limits = ifelse(df$FC > 25 | df$FC < -25,1,0)

plot(df$TIMESTAMP,df$FC,ylim = c(-25,25))

ggplot(data = df)+
  geom_point(aes(TIMESTAMP,FC,color = FC.limits))
# hist(FC.limits,breaks=100)
```
...
plot(df$TIMESTAMP,df$FCH4,ylim = c(-30,350));abline(h=.3, col= 'red');abline(h=-.20, col='red'); abline(h=0,col= 'black')
```

Clean based on graphs, create new variable (FCH4.limits), and see cleaned product

```{r, warning=FALSE}
CH4MOLE = ggplot(data = df)+geom_hline(yintercept = 0)+
  geom_point(aes(x=TIMESTAMP,y=df$CH4))+
...
# FCH4.limits = ifelse(df$FCH4 < 3 & df$TIMESTAMP <= '2023-9-21 11:00' & df$TIMESTAMP >='2023-9-14 16:30',NA,
#                           ifelse(df$FCH4 < -.20,NA,
#                                  ifelse(df$FCH4 > .3,NA,FCH4.limits)))


hist(FCH4.limits,breaks = 100)
plot(FCH4.limits)

ggplot(data = df)+geom_hline(yintercept = 0)+
  geom_point(aes(x=TIMESTAMP,y=FCH4),col = 'red')+
  geom_point(aes(x=TIMESTAMP,y=FCH4.limits),col = 'black')+
...
```{r, warning=FALSE}
df$nightCO2 = ifelse(FC.limits == 1,NA,df$FC)
df$nightCO2 = replace(df$nightCO2,df$SW_IN > 0,NA)
...
```{r, warning=FALSE}
co2fluxclean = ifelse(FC.limits == 1 | df$u_flag == 1 ,NA,df$FC)

ch4fluxclean = ifelse(is.na(FCH4.limits) | df$u_flag ==1 ,NA,df$FCH4)
...
ggplot(data = df)+
  geom_point(aes(TIMESTAMP,FC,color = u_flag))+
  scale_x_datetime(limits = as.POSIXct(c('2019-07-01','2019-07-14')))
...
#Add clean value to dataframe (_.c)
df$FC.roll = ifelse(abs(co2fluxclean - Flux_filt) > (N * roll.mad),1,0)

#Compare cleaned vs. uncleaned
ggplot(data = df)+geom_hline(yintercept = 0)+
  geom_point(aes(TIMESTAMP,FC,col=FC.roll))+
  scale_x_datetime(limits = as.POSIXct(c('2019-07-01','2019-08-25')))
```

```{r, warning=FALSE}

df$FC.c = ifelse(FC.limits == 1 | df$FC.roll == 1,NA,df$FC)
...
ggplot(data = df)+theme_bw()+geom_hline(yintercept = 0)+
  geom_point(aes(TIMESTAMP,FC), col='red')+
  geom_point(aes(TIMESTAMP,FC.c), col='black')+
  scale_x_datetime(limits = as.POSIXct(c('2019-7-14','2019-8-28'),format="%F"))+
  scale_y_continuous (expression('NEE ('*mu*mol~m^-2~s^-1*')'),
                      limits = c(-20,20))
```
...
ggplot(data = df)+
  ...
  scale_x_datetime(limits = as.POSIXct(c('2020-09-01','2020-12-30'),format="%F"))
```
...
diel = df %>%
  group_by(hour,month) %>%
  select(FC.c,FCH4.c,LE.c,H.c,hour,month) %>%
...
```{r, warning=FALSE}
ggplot(data = diel)+geom_hline(yintercept = 0)+
  geom_line(aes(hour,FCH4.c_fn1),lty=2)+
  geom_ribbon(aes(x = hour,y = FCH4.c_fn1,
                  ymax = FCH4.c_fn1 + FCH4.c_fn2,
                  ymin = FCH4.c_fn1 - FCH4.c_fn2),
              alpha= 0.5)+
  facet_wrap(~month)

ggplot(data = diel)+geom_hline(yintercept = 0)+
  geom_line(aes(hour,FCH4.c_fn1*43.2),lty=2)+
  geom_ribbon(aes(x = hour,y = FCH4.c_fn1*43.2,
                  ymax = FCH4.c_fn1*43.2 + FCH4.c_fn2*43.2,
                  ymin = FCH4.c_fn1*43.2 - FCH4.c_fn2*43.2),
              alpha= 0.5)+
