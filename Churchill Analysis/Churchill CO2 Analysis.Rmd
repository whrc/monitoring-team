...
Uses ratio of par in/out, soil heat flux data, snow depth, air temp to identify snow melt period
...
# Defines seasons in the 2023 dataframe using a column of character values
...
These don't work right now, need to switch dataframe definitions
