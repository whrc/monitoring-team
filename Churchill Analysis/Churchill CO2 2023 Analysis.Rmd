...
####Simplified Version of Seasonal Plot
...
ts_columns <- rep(c("TS_1_0_1", "TS_1_05_1", "TS_1_1_1",  "TS_1_2_1",  "TS_1_3_1",  "TS_1_4_1",  "TS_1_5_1",  "TS_1_6_1",  "TS_1_7_1",  "TS_1_8_1",  "TS_1_9_1",  "TS_1_10_1"), nrow(df_2023))

#Creates dataframe with timestamp repeated 12 times and merges is with soil depth values

df_soiltemp = select(df_2023, TIMESTAMP, grep("^TS_1", names(df), value = TRUE)) 

df_soiltemp = df_soiltemp %>%
  slice(rep(1:n(), each = 12)) %>%
  bind_cols(ts_columns)

names(df_soiltemp)[14] <- "Depth"

rm(ts_columns)

for(1:nrow(df_soiltemp)) {
...
#use geom_raster to turn this table into a plot
