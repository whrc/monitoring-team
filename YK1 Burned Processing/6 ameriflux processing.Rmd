...
Load Data
```{r}
df = fread(input = "./ykd_burned_gapfilled_clean_2019_2022.csv")
```
...
# H2O_SIGMA = sqrt(df$h2o_var/1000)
...
G_3_1_1 = ifelse(df$SHF_3_1_1.c > 125,NA,df$SHF_3_1_1.c)
...
```{r}
US_YK1 = data.frame(TIMESTAMP_START,TIMESTAMP_END,
  CO2,CH4,H2O
...
siteID = "US-YK1"
resolution = 'HH'
tsstart = US_YK1$TIMESTAMP_START[1]
tsend   = US_YK1$TIMESTAMP_END[nrow(US_YK1)]

filename = paste(siteID,resolution,tsstart,tsend,sep = '_')
filename = paste("./",filename,".csv",sep = "")

write.csv(x = US_YK1,file = filename,row.names = F,na = "-9999",quote = F)
```
