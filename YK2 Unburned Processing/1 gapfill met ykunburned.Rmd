...
df = rbind(c19,c20,c21,c22,c23,fill=T)

#check timestamp
ggplot(data = df)+
  geom_point(aes(ts,SWIN_1_1_1))+
  scale_x_datetime(limits = as.POSIXct(c("2023-07-01","2023-07-03")))
...
```{r}
write.csv(x = df,file = "./ykd_unburned_2019_2023.csv",row.names = F)
```
