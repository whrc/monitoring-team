...
df = fread('C:/Users/karndt.WHRC/desktop/churchill/data/met/churchillFenBiomet_Aug2022-Jan2023.csv',na.strings = c('-9999','NA','NaN','NAN','-7999'))

h = fread('C:/Users/karndt.WHRC/desktop/churchill/data/met/Churchill_AllBiomet_until20230620.dat',skip=1 ,nrows = 0)
dat = fread('C:/Users/karndt.WHRC/desktop/churchill/data/met/Churchill_AllBiomet_until20230620.dat',skip=4, header = FALSE, na.strings=c('-9999','NA','NaN','NAN',"-7999"))

h2 = fread('C:/Users/karndt.WHRC/desktop/churchill/data/met/Churchill_AllBiomet_until20230712.dat',skip=1 ,nrows = 0)
dat2 = fread('C:/Users/karndt.WHRC/desktop/churchill/data/met/Churchill_AllBiomet_until20230712.dat',skip=4, header = FALSE, na.strings=c('-9999','NA','NaN','NAN',"-7999"))

h3 = fread('C:/Users/karndt.WHRC/desktop/churchill/data/met/Churchill_AllBiomet.dat',skip=1 ,nrows = 0)
dat3 = fread('C:/Users/karndt.WHRC/desktop/churchill/data/met/Churchill_AllBiomet.dat',skip=4, header = FALSE, na.strings=c('-9999','NA','NaN','NAN',"-7999"))
...
#write.csv(x = df,file = 'C:/Users/karndt/desktop/churchill/data/Churchill_met_merged.csv',row.names = F,quote = F)
...
PA_4_2_1_1_1.limits = ifelse(df$PA_4_2_1_1_1 > 110 | df$PA_4_2_1_1_1 < 90,NA, df$PA_4_2_1_1_1)
...
```{r, warning=FALSE}
write.csv(x = df,file = 'C:/Users/karndt/desktop/churchill/data/Cleaned/Churchill_met_clean.csv',row.names = F,quote = F)
```
...
met = fread('C:/Users/karndt/desktop/churchill/data/Cleaned/Churchill_met_clean.csv')

df = fread('C:/Users/karndt.WHRC/desktop/churchill/data/Churchill_fluxes_merged.csv')
...
```{r, warning=FALSE}
u_flag = ifelse(df$`u*` < Uthreshold,1,0)
...
write.csv(x = df,file = 'C:/Users/karndt/desktop/churchill/data/Cleaned/Churchill_clean.csv',row.names = F,quote = F)
```
