...
df = fread('C:/Permafrost Pathways/Data/met/churchillFenBiomet_Aug2022-Jan2023.csv')

h = fread('C:/Permafrost Pathways/Data/met/Churchill_AllBiomet_until20230620.dat',skip=1 ,nrows = 0)
dat = fread('C:/Permafrost Pathways/Data/met/Churchill_AllBiomet_until20230620.dat',skip=4, header = FALSE, na.strings=c('-9999','NA','NaN','NAN'))

h2 = fread('C:/Permafrost Pathways/Data/met/Churchill_AllBiomet_until20230712.dat',skip=1 ,nrows = 0)
dat2 = fread('C:/Permafrost Pathways/Data/met/Churchill_AllBiomet_until20230712.dat',skip=4, header = FALSE, na.strings=c('-9999','NA','NaN','NAN'))

h3 = fread('C:/Permafrost Pathways/Data/met/Churchill_AllBiomet.dat',skip=1 ,nrows = 0)
dat3 = fread('C:/Permafrost Pathways/Data/met/Churchill_AllBiomet.dat',skip=4, header = FALSE, na.strings=c('-9999','NA','NaN','NAN'))
...
write.csv(x = df,file = 'C:/Permafrost Pathways/Data/Churchill_met_merged.csv',row.names = F,quote = F)
```
# Air T
```{r, warning=FALSE}
ggplot(data = df)+
  ...
  scale_x_datetime(limits = as.POSIXct(c('2022-8-6','2023-10-31')))
```
## Limits
```{r, warning=FALSE}
hist(df$TA_2_1_1_1_1,breaks=100)
plot(df$TIMESTAMP,df$TA_2_1_1_1_1,ylim = c(-45,40));abline(h=-43, col= 'red');abline(h=40, col='red')
TA_2_1_1_1_1.limits = replace(df$TA_2_1_1_1_1, df$TA_2_1_1_1_1 < -43 | df$TA_2_1_1_1_1 > 40,NA)
...
ggplot(data = df)+
  ...
  scale_x_datetime(limits = as.POSIXct(c('2022-8-6','2023-11-3')))
```
## Limits
```{r,warning=FALSE}
...
ggplot(data = df)+
  ...
  scale_y_continuous(limits = c(5,100),
                     expression('Relative Humidity ('*percent*')'))+
  scale_x_datetime(limits = as.POSIXct(c('2022-8-6','2023-11-1')))
...
ggplot(data = df)+
  ...
  scale_y_continuous(limits = c(0,1150),
                     expression ('Barometric Pressure ('*kPa*')'))+
  scale_x_datetime(limits = as.POSIXct(c('2023-1-31','2023-2-1')))



PA_4_2_1_1_1.limits = df$PA_4_2_1_1_1

PA_4_2_1_1_1.limits = ifelse(df$PA_4_2_1_1_1 >= 200 & df$TIMESTAMP <= '2023-2-2'  ,df$PA_4_2_1_1_1 /10, PA_4_2_1_1_1.limits)
...
ggplot(data = df)+
  ...
  scale_y_continuous(limits = c(90,110),
                     expression ('Barometric Pressure ('*kPa*')'))+
  scale_x_datetime(limits = as.POSIXct(c('2022-8-6','2023-11-2')))



PA_4_2_1_1_1.limits = replace(PA_4_2_1_1_1.limits, PA_4_2_1_1_1.limits < 97 | PA_4_2_1_1_1.limits > 106,NA)
```
## Rolling MAD
```{r, warning=FALSE}
...
ggplot(df)+geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(c('2022-8-5','2023-11-1'),format="%F"))+
...
scale_x_datetime(limits = as.POSIXct(c('2022-8-6','2023-11-1'),format="%F"))
```
#Soil Heat Flux
```{r, warning=FALSE}
...
ggplot(data = df)+
  ...
  scale_x_datetime(limits = as.POSIXct(c('2022-10-26','2023-11-1')))
```
```{r, warning=FALSE}
...
ggplot(data = df)+
  ...
  scale_y_continuous(limits = c(-.25,.75),
                     expression('Snow Depth ('*m*')'))+
  scale_x_datetime(limits = as.POSIXct(c('2022-8-26','2023-11-1')))
...
ggplot(df)+geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(c('2022-10-5','2023-11-1'),format="%F"))+
  scale_color_manual(values=c('yellow','red','black'))
...
ggplot(df)+geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(c('2023-4-25','2023-5-10'),format="%F"))+
  scale_color_manual(values=c('black','red'))
```
...
scale_x_datetime(limits = as.POSIXct(c('2023-2-6','2023-4-15'),format="%F"))
```
...
scale_x_datetime(limits = as.POSIXct(c('2022-11-26','2023-1-25'),format="%F"))
```
# PAR Reflected
```{r, warning=FALSE}
ggplot(data = df)+
...
ggplot(df)+geom_hline(yintercept = 0)+
  geom_point(aes(TIMESTAMP,PPFDR_7_23_1_1_1.limits,col='Uncleaned'))+
...
scale_x_datetime(limits = as.POSIXct(c('2023-10-9','2023-11-3'),format="%F"))
```
# Net Radiation 
```{r, warning=FALSE}
ggplot(data = df)+
...
ggplot(df)+geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(c('2022-8-6','2023-6-20'),format="%F"))+
  scale_color_manual(values=c('black','red'))
```
...
ggplot(data = df)+
  ...
  scale_x_datetime(limits = as.POSIXct(c("2022-9-22",'2023-11-1')))
```
...
ggplot(df)+geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(c('2022-9-20','2023-11-1'),format="%F"))+
  scale_color_manual(values=c('yellow','red','black'))
...
ggplot(data = df)+
  ...
  scale_y_continuous(limits = c(-1,2),
                     expression('Snow Depth ('*m*')'))+
  scale_x_datetime(limits = as.POSIXct(c("2022-9-22",'2023-11-2')))
...
ggplot(data = df)+
  ...
  scale_x_datetime(limits = as.POSIXct(c("2022-9-21",'2023-11-1')))
...
ggplot(data = df)+
  ...
  scale_x_datetime(limits = as.POSIXct(c("2022-09-12",'2023-10-31')))
```
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(c("2022-8-6",'2023-6-20')))
...
TS_2_38_3_1_1.limits = ifelse(df$TS_2_38_3_1_1 >= -100 & df$TIMESTAMP >= '2023-4-9' & df$TIMESTAMP <= '2023-6-12' ,NA, TS_2_38_3_1_1.limits)
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  geom_line(aes(TIMESTAMP, TS_2_38_3_1_1.limits, col = 'Surface'))+
  scale_y_continuous(limits = c(-15,25),
                     expression('Open Water Therms Soil T ('*C*')'))+
  scale_x_datetime(limits = as.POSIXct(c("2022-8-6",'2023-7-14')))
...
ggplot(data = df)+
  ...
  scale_y_continuous(limits = c(-15,30))+
scale_x_datetime(limits = as.POSIXct(c('2022-10-12','2022-12-2'),format="%F"))
```
  scale_y_continuous(limits = c(-15,25),
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(c("2022-8-4",'2023-11-1')))
...
TS_2_38_3_3_1.limits = ifelse(df$TS_2_38_3_3_1 <= 0 & df$TIMESTAMP >= '2022-10-18' & df$TIMESTAMP <= '2022-10-22' ,NA, TS_2_38_3_3_1.limits)
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_y_continuous(limits = c(-10,8.5),
                     expression('Open Water Therms Soil T ('*C*')'))+
  scale_x_datetime(limits = as.POSIXct(c("2022-8-6",'2023-11-1')))
TS_2_38_3_5_1 = df$TS_2_38_3_5_1
```
## Rolling MAD 
```{r, warning=FALSE}
f = TS_2_38_3_5_1 # first make a new flux vector to apply the above filters
# prepare the inputs for a zero-phase (forward and reverse) filter  
ind       = which(complete.cases(f))   # first save the index of all the NAs
b         = rep(1,8)/8                 # moving average coefficient
a         = 1                          # coefficient of the ARMA filter
...
ggplot(df)+geom_hline(yintercept = 0)+
  geom_point(aes(TIMESTAMP,TS_2_38_3_5_1,col='Open Water 30 cm Soil T'))+
  geom_line(aes(TIMESTAMP,mad_filt,col='Filter'))+
  geom_line(aes(TIMESTAMP,roll.mad,col='MAD'))+
  scale_y_continuous(limits = c(-10,8.5))+
  scale_x_datetime(limits = as.POSIXct(c('2022-8-6','2023-11-1'),format="%F"))+
...
df$TS_2_38_3_5_1.c = ifelse(abs(TS_2_38_3_5_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_3_5_1)
...
ggplot(data = df)+
  ...
  geom_ribbon(aes(x = TIMESTAMP,ymax = mad_filt+roll.mad*2,ymin = mad_filt-roll.mad*2,fill='2'))+
  geom_ribbon(aes(x = TIMESTAMP,ymax = mad_filt+roll.mad*1,ymin = mad_filt-roll.mad*1,fill='1'))+
  geom_point(aes(TIMESTAMP,TS_2_38_3_5_1),col='red')+
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_y_continuous(limits = c(-10,7.5),
                     expression('Open Water Therms Soil T ('*C*')'))+
  scale_x_datetime(limits = as.POSIXct(c("2022-8-6",'2023-11-1')))
TS_2_38_3_6_1 = df$TS_2_38_3_6_1
```
## Rolling MAD 
```{r, warning=FALSE}
f = TS_2_38_3_6_1 # first make a new flux vector to apply the above filters
# prepare the inputs for a zero-phase (forward and reverse) filter  
ind       = which(complete.cases(f))   # first save the index of all the NAs
b         = rep(1,8)/8                 # moving average coefficient
a         = 1                          # coefficient of the ARMA filter
...
ggplot(df)+geom_hline(yintercept = 0)+
  geom_point(aes(TIMESTAMP,TS_2_38_3_6_1,col='Open Water 40 cm Soil T'))+
  geom_line(aes(TIMESTAMP,mad_filt,col='Filter'))+
  geom_line(aes(TIMESTAMP,roll.mad,col='MAD'))+
  scale_y_continuous(limits = c(-10,7.5))+
  scale_x_datetime(limits = as.POSIXct(c('2022-8-6','2023-11-1'),format="%F"))+
...
df$TS_2_38_3_6_1.c = ifelse(abs(TS_2_38_3_6_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_3_6_1)
...
ggplot(data = df)+
  ...
  geom_ribbon(aes(x = TIMESTAMP,ymax = mad_filt+roll.mad*2,ymin = mad_filt-roll.mad*2,fill='2'))+
  geom_ribbon(aes(x = TIMESTAMP,ymax = mad_filt+roll.mad*1,ymin = mad_filt-roll.mad*1,fill='1'))+
  geom_point(aes(TIMESTAMP,TS_2_38_3_6_1),col='red')+
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_x_datetime(limits = as.POSIXct(c("2022-8-6",'2023-11-1')))
TS_2_38_3_7_1 = df$TS_2_38_3_7_1
```
## Rolling MAD 
```{r, warning=FALSE}
f = TS_2_38_3_7_1 # first make a new flux vector to apply the above filters
# prepare the inputs for a zero-phase (forward and reverse) filter  
ind       = which(complete.cases(f))   # first save the index of all the NAs
b         = rep(1,8)/8                 # moving average coefficient
a         = 1                          # coefficient of the ARMA filter
...
ggplot(df)+geom_hline(yintercept = 0)+
  geom_point(aes(TIMESTAMP,TS_2_38_3_7_1,col='Open Water 50 cm Soil T'))+
  geom_line(aes(TIMESTAMP,mad_filt,col='Filter'))+
  geom_line(aes(TIMESTAMP,roll.mad,col='MAD'))+
  scale_y_continuous(limits = c(-10,7.5))+
  scale_x_datetime(limits = as.POSIXct(c('2022-8-6','2023-11-1'),format="%F"))+
...
df$TS_2_38_3_7_1.c = ifelse(abs(TS_2_38_3_7_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_3_7_1)
...
ggplot(data = df)+
  ...
  geom_ribbon(aes(x = TIMESTAMP,ymax = mad_filt+roll.mad*2,ymin = mad_filt-roll.mad*2,fill='2'))+
  geom_ribbon(aes(x = TIMESTAMP,ymax = mad_filt+roll.mad*1,ymin = mad_filt-roll.mad*1,fill='1'))+
  geom_point(aes(TIMESTAMP,TS_2_38_3_7_1),col='red')+
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_y_continuous(limits = c(-10,5),
                     expression('Open Water Therms Soil T ('*K*')'))+
  scale_x_datetime(limits = as.POSIXct(c("2022-8-6",'2023-11-1')))
TS_2_38_3_8_1 = df$TS_2_38_3_8_1
```
## Rolling MAD 
```{r, warning=FALSE}
f = TS_2_38_3_8_1 # first make a new flux vector to apply the above filters
# prepare the inputs for a zero-phase (forward and reverse) filter  
ind       = which(complete.cases(f))   # first save the index of all the NAs
b         = rep(1,8)/8                 # moving average coefficient
a         = 1                          # coefficient of the ARMA filter
...
ggplot(df)+geom_hline(yintercept = 0)+
  geom_point(aes(TIMESTAMP,TS_2_38_3_8_1,col='Open Water 60 cm Soil T'))+
  geom_line(aes(TIMESTAMP,mad_filt,col='Filter'))+
  geom_line(aes(TIMESTAMP,roll.mad,col='MAD'))+
  scale_y_continuous(limits = c(-10,5))+
  scale_x_datetime(limits = as.POSIXct(c('2022-8-6','2023-11-1'),format="%F"))+
...
df$TS_2_38_3_8_1.c = ifelse(abs(TS_2_38_3_8_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_3_8_1)
...
ggplot(data = df)+
  ...
  geom_ribbon(aes(x = TIMESTAMP,ymax = mad_filt+roll.mad*2,ymin = mad_filt-roll.mad*2,fill='2'))+
  geom_ribbon(aes(x = TIMESTAMP,ymax = mad_filt+roll.mad*1,ymin = mad_filt-roll.mad*1,fill='1'))+
  geom_point(aes(TIMESTAMP,TS_2_38_3_8_1),col='red')+
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_y_continuous(limits = c(-10,5),
                     expression('Open Water Therms Soil T ('*K*')'))+
  scale_x_datetime(limits = as.POSIXct(c("2022-8-6",'2023-11-1')))
TS_2_38_3_9_1 = df$TS_2_38_3_9_1
```
## Rolling MAD 
```{r, warning=FALSE}
f = TS_2_38_3_9_1 # first make a new flux vector to apply the above filters
# prepare the inputs for a zero-phase (forward and reverse) filter  
ind       = which(complete.cases(f))   # first save the index of all the NAs
b         = rep(1,8)/8                 # moving average coefficient
a         = 1                          # coefficient of the ARMA filter
...
ggplot(df)+geom_hline(yintercept = 0)+
  geom_point(aes(TIMESTAMP,TS_2_38_3_9_1,col='Open Water 70 cm Soil T'))+
  geom_line(aes(TIMESTAMP,mad_filt,col='Filter'))+
  geom_line(aes(TIMESTAMP,roll.mad,col='MAD'))+
  scale_y_continuous(limits = c(-10,5))+
  scale_x_datetime(limits = as.POSIXct(c('2022-8-6','2023-11-1'),format="%F"))+
...
df$TS_2_38_3_9_1.c = ifelse(abs(TS_2_38_3_9_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_3_9_1)
...
ggplot(data = df)+
  ...
  geom_ribbon(aes(x = TIMESTAMP,ymax = mad_filt+roll.mad*2,ymin = mad_filt-roll.mad*2,fill='2'))+
  geom_ribbon(aes(x = TIMESTAMP,ymax = mad_filt+roll.mad*1,ymin = mad_filt-roll.mad*1,fill='1'))+
  geom_point(aes(TIMESTAMP,TS_2_38_3_9_1),col='red')+
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_y_continuous(limits = c(-10,5),
                     expression('Open Water Therms Soil T ('*K*')'))+
  scale_x_datetime(limits = as.POSIXct(c("2022-8-6",'2023-11-1')))
TS_2_38_3_10_1 = df$TS_2_38_3_10_1
```
## Rolling MAD 
```{r, warning=FALSE}
f = TS_2_38_3_10_1 # first make a new flux vector to apply the above filters
# prepare the inputs for a zero-phase (forward and reverse) filter  
ind       = which(complete.cases(f))   # first save the index of all the NAs
b         = rep(1,8)/8                 # moving average coefficient
a         = 1                          # coefficient of the ARMA filter
...
ggplot(df)+geom_hline(yintercept = 0)+
  geom_point(aes(TIMESTAMP,TS_2_38_3_10_1,col='Open Water 80 cm Soil T'))+
  geom_line(aes(TIMESTAMP,mad_filt,col='Filter'))+
  geom_line(aes(TIMESTAMP,roll.mad,col='MAD'))+
...
df$TS_2_38_3_10_1.c = ifelse(abs(TS_2_38_3_10_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_3_10_1)
...
ggplot(data = df)+
  ...
  geom_ribbon(aes(x = TIMESTAMP,ymax = mad_filt+roll.mad*2,ymin = mad_filt-roll.mad*2,fill='2'))+
  geom_ribbon(aes(x = TIMESTAMP,ymax = mad_filt+roll.mad*1,ymin = mad_filt-roll.mad*1,fill='1'))+
  geom_point(aes(TIMESTAMP,TS_2_38_3_10_1),col='red')+
...
ggplot(data = df)+ theme_bw()+ geom_hline(yintercept = 0)+
  ...
  scale_y_continuous(limits = c(-10,5),
                     expression('Open Water Therms Soil T ('*K*')'))+
  scale_x_datetime(limits = as.POSIXct(c("2022-8-6",'2023-11-1')))
TS_2_38_3_11_1 = df$TS_2_38_3_11_1
```
## Rolling MAD 
```{r, warning=FALSE}
f = TS_2_38_3_11_1 # first make a new flux vector to apply the above filters
# prepare the inputs for a zero-phase (forward and reverse) filter  
ind       = which(complete.cases(f))   # first save the index of all the NAs
b         = rep(1,8)/8                 # moving average coefficient
a         = 1                          # coefficient of the ARMA filter
...
ggplot(df)+geom_hline(yintercept = 0)+
  geom_point(aes(TIMESTAMP,TS_2_38_3_11_1,col='Open Water 80 cm Soil T'))+
  geom_line(aes(TIMESTAMP,mad_filt,col='Filter'))+
  geom_line(aes(TIMESTAMP,roll.mad,col='MAD'))+
  scale_y_continuous(limits = c(-8,3.5))+
  scale_x_datetime(limits = as.POSIXct(c('2022-8-6','2023-11-1'),format="%F"))+
...
df$TS_2_38_3_11_1.c = ifelse(abs(TS_2_38_3_11_1 - mad_filt) > (N * roll.mad),NA,TS_2_38_3_11_1)
...
ggplot(df)+geom_hline(yintercept = 0)+
  geom_point(aes(TIMESTAMP,TS_2_38_3_12_1.limits,col='Open Water 80 cm Soil T'))+
  geom_line(aes(TIMESTAMP,mad_filt,col='Filter'))+
  geom_line(aes(TIMESTAMP,roll.mad,col='MAD'))+
  scale_y_continuous(limits = c(-8,3.5))+
  scale_x_datetime(limits = as.POSIXct(c('2022-8-6','2023-11-1'),format="%F"))+
...
```{r, warning=FALSE}
write.csv(x = df,file = 'C:/Permafrost Pathways/Data/Cleaned/Churchill_met_clean.csv',row.names = F,quote = F)
```
...
met = fread('C:/Permafrost Pathways/Data/Cleaned/Churchill_met_clean.csv')

df = fread('C:/Permafrost Pathways/Data/Churchill_fluxes_merged.csv')
...
Tau.limits = replace(df$Tau,df$Tau.c < .2,NA)
```
...
```{r, warning=FALSE}
co2_flux.limits = replace(df$co2_flux,df$co2_flux > 10 | df$co2_flux < -14,NA)
...
plot(df$ts,df$ch4_flux,ylim = c(-.3,.35));abline(h=.3, col= 'red');abline(h=-.26, col='red'); abline(h=0,col= 'black')
```
...
```{r, warning=FALSE}
LE.limits = replace(df$LE, df$LE < -80 | df$LE > 390,NA)
hist(LE.limits)
plot(LE.limits)
```
...
pick threshold and filter based on plots above, I liked .07
...
write.csv(x = df,file = 'C:/Permafrost Pathways/Data/Cleaned/Churchill_clean.csv',row.names = F,quote = F)
```
